<?php
if ($keranjang['keranjang_total'] == 0 || $keranjang == null) :
?>
	<div class="container">
				...
				?>
					...
					<table class="table table-bordered table-shopping-cart">
						...
						<tbody>
							...
							?>
								<tr>
									<td><img src="<?= base_url('assets/images/stiker/') . $value['stiker_foto'] ?>" alt="foto" style="width: 100%"></td>
									...
									<td><a class="fa fa-close table-shopping-remove" href="<?= base_url('hapus/stiker/' . $value['stiker_id']) ?>" onclick="return confirm('Hapus Pesanan? ')"></a></td>
								</tr>
							<?php
							endforeach;
							?>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><a class="fa fa-close table-shopping-remove" href="<?= base_url('hapus/spanduk/' . $value['spanduk_id']) ?>" onclick="return confirm('Hapus Pesanan? ')"></a></td>
								</tr>
							<?php
							endforeach;
							?>
				...
				?>
					...
					<table class="table table-bordered table-shopping-cart">
						...
						<tbody>
							...
							?>
								<tr>
									<td><img src="<?= base_url('assets/images/kartu/') . $value['kartu_foto'] ?>" alt="foto" style="width: 100%"></td>
									...
									<td><a class="fa fa-close table-shopping-remove" href="<?= base_url('hapus/kartu/' . $value['kartu_id']) ?>" onclick="return confirm('Hapus Pesanan? ')"></a></td>
								</tr>
							<?php
							endforeach;
							?>
				...
				?>
					...
					<table class="table table-bordered table-shopping-cart">
						...
						<tbody>
							...
							?>
								<tr>
									<td><img src="<?= base_url('assets/images/brosur/') . $value['brosur_foto'] ?>" alt="foto" style="width: 100%"></td>
									...
									<td><a class="fa fa-close table-shopping-remove" href="<?= base_url('hapus/brosur/' . $value['brosur_id']) ?>" onclick="return confirm('Hapus Pesanan? ')"></a></td>
								</tr>
							<?php
							endforeach;
							?>
