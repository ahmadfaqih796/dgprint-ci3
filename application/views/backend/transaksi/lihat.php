				...
				<div>
					<table width="100%">
						...
						<tr>
							...
							<td> :</td>
							<td>&nbsp;
								<img src="<?= base_url('assets/images/struk/' . $konfirmasi['konfirmasi_struk']) ?>" width="70%" alt="Struk">
							</td>
						</tr>
						<tr>
							<td></td>
							...
							<td><?php
									...
									?>
										<div class="alert alert-success alert-dismissible animated fadeInDown round" style="" id="feedback" role="alert">
