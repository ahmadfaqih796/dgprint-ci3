...
<head>
	...
	<title>DigitalPrinting.Net</title>
	<!-- plugins:css -->
		...
		<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row d-print-none">
			...
			<div class="navbar-menu-wrapper d-flex align-items-center">
				...
				<ul class="navbar-nav navbar-nav-right">
					...
					<li class="nav-item nav-settings d-none d-lg-block">
						<a class="nav-link" href="<?php echo base_url() ?>admin/logout" onclick="return confirm('Apakah anda yakin ingin keluar?')" title="Keluar">
			...
			<div class="row row-offcanvas row-offcanvas-right">
				...
				<div class="content-wrapper">
					<div class="row">
						...
						?>
							<div class="alert alert-success alert-dismissible animated fadeInDown" style="width: 100%" id="feedback" role="alert">
						...
						?>
							<div class="alert alert-warning alert-dismissible animated fadeInDown" style="width: 100%" id="feedback" role="alert">
								<button type="button" class="close" data-dismiss="alert" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
								Sudah Login
