	...
	<div class="container">
		<div class="row row-col-gap" data-gutter="60">
			<div class="col-md-3">
				...
				<p>CV. Agung Sejahtera melayani : digital printing, seperti cetak spanduk, brosur, kop surat, amplop, kartu nama, dan perdagangan administrasi umum lainnya</p>
			...
			<div class="col-md-3">
				...
				<p>Jl. Cipinang Cempedak IV, No.5 Cawang, Jakarta Timur 13340</p>
			</div>
			<div class="col-md-3">
...
<div class="copyright-area">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<p class="copyright-text">Copyright &copy; <a href="https://web.facebook.com/mansyur.muhammad.946">Muhammad Mansyur</a> (18171065118). All rights reseved</p>
			</div>
			<div class="col-md-6">
			</div>
		</div>
